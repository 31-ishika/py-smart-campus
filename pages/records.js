    ...
    <div>
      <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="text-gray-300">View student IDs, names, scores, grade and remark without subject-wise breakdown.</p>
        </div>
      </header>
      ...
      <section className="grid gap-4 lg:grid-cols-3 mb-6">
        <Card title="Class Average">
          ...
          <p className="text-sm text-gray-400">Average performance across all student records.</p>
        </Card>
        <Card title="Top Performer">
          <div className="text-lg font-semibold">{topStudent.name}</div>
          <div className="text-sm text-gray-400">Score: {topStudent.average}%</div>
        </Card>
        <Card title="Student Count">
          <div className="text-3xl font-semibold">{data.length}</div>
          <p className="text-sm text-gray-400">Total records in the system.</p>
        </Card>
      </section>

      <Card title="Records Table">
